      ...
      try {
        ...
        if (role == 'Manager') {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => ManagerPage(managerName: name),
            ),
          );
        } else if (role == 'Staff') {
          Navigator.pushReplacement(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  StaffPage(staffName: name, staffRole: role),
            ),
          );
        } else if (role == 'Chef') {
          Navigator.pushReplacement(
        ...
        // Firebase login errors (wrong password, user not found, etc.)
        setState(() {
    ...
    return Scaffold(
      body: Stack(
        ...
        children: [
          ...
          // Blur overlay for aesthetic effect
          BackdropFilter(
